---
name: ship-code-change-frontend
description: 'Git workflow: create branch, commit, run code-reviewer, run tests, push, and open a PR for Kalba frontend work. Use when shipping a finished task or preparing a frontend PR in Claude.'
