...
description: 'Create an iOS TestFlight build from Windows/macOS with explicit build number control, EAS build, and EAS submit. Use when publishing a frontend iOS build to TestFlight in Claude.'
