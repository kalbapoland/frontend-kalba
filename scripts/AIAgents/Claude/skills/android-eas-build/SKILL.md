...
description: 'Create Android EAS builds for development or production. Version code is managed automatically by EAS (remote source + autoIncrement on production). Use when shipping an Android build to Play Console or installing locally on a device in Claude.'
